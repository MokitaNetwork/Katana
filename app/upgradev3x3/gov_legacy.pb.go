...
// source: katana/leverage/v1/gov.proto
...
// registry can be updated in the Katana capital facility. Note, the registry
...
func init() {
	proto.RegisterType((*UpdateRegistryProposal)(nil), "katana.leverage.v1.UpdateRegistryProposal")
}

func init() { proto.RegisterFile("katana/leverage/v1/gov.proto", fileDescriptor_3febb94c702124d7) }
