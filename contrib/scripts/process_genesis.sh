...
EXPORTED_GENESIS_UNPROCESSED_PATH="${EXPORTED_GENESIS_UNPROCESSED_PATH:-$CWD/katanamania/katanamania.genesis.json}"
EXPORTED_GENESIS_PROCESSED_PATH="${EXPORTED_GENESIS_PROCESSED_PATH:-$CWD/katanamania/tinkered_genesis.json}"
COSMOS_GENESIS_TINKERER_PATH="${COSMOS_GENESIS_TINKERER_PATH:-$CWD/cosmos-genesis-tinkerer}"
COSMOS_GENESIS_TINKERER_SCRIPT="${COSMOS_GENESIS_TINKERER_SCRIPT:-katanamania-fork.py}"
