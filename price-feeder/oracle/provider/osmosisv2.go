...
const (
	osmosisV2WSHost   = "api.osmo-api.network.katana.cc"
	osmosisV2WSPath   = "ws"
	osmosisV2RestHost = "https://api.osmo-api.network.katana.cc"
...
type (
	// OsmosisV2Provider defines an Oracle provider implemented by KATANA's
	// Osmosis API.
	//
