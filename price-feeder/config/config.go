...
type (
	...
	// Account defines account related configuration that is related to the Katana
	...
	// Keyring defines the required Katana keyring configuration.
	Keyring struct {
		Backend string `mapstructure:"backend" validate:"required"`
		Dir     string `mapstructure:"dir" validate:"required"`
	}

	// RPC defines RPC configuration of both the Katana gRPC and Tendermint nodes.
	RPC struct {
