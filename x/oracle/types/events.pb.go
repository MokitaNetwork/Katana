...
// source: katana/oracle/v1/events.proto
...
func init() {
	proto.RegisterType((*EventDelegateFeedConsent)(nil), "katana.oracle.v1.EventDelegateFeedConsent")
	proto.RegisterType((*EventSetFxRate)(nil), "katana.oracle.v1.EventSetFxRate")
}

func init() { proto.RegisterFile("katana/oracle/v1/events.proto", fileDescriptor_6380f28dac582975) }
