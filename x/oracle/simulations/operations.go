...
var (
	acceptList = []string{types.KatanaSymbol, types.USDDenom}
	katanaPrice  = sdk.MustNewDecFromStr("25.71")
)
...
func SimulateMsgAggregateExchangeRatePrevote(
	...
	return func(
		...
		for _, denom := range acceptList {
			prices[denom] = katanaPrice.Add(simtypes.RandomDecAmount(r, sdk.NewDec(1)))
		}
